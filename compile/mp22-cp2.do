echo "--- Executing initialization force file for ../testcode/mp22-cp2.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp22-cp2.asm program code."
run 5
change mp2_cpu/dram/pdram/vhdl_memory/mem(0) X"0B"
change mp2_cpu/dram/pdram/vhdl_memory/mem(1) X"62"
change mp2_cpu/dram/pdram/vhdl_memory/mem(2) X"0C"
change mp2_cpu/dram/pdram/vhdl_memory/mem(3) X"64"
change mp2_cpu/dram/pdram/vhdl_memory/mem(4) X"0D"
...
change mp2_cpu/dram/pdram/vhdl_memory/mem(15) X"60"
change mp2_cpu/dram/pdram/vhdl_memory/mem(16) X"C0"
change mp2_cpu/dram/pdram/vhdl_memory/mem(17) X"62"
change mp2_cpu/dram/pdram/vhdl_memory/mem(18) X"80"
change mp2_cpu/dram/pdram/vhdl_memory/mem(19) X"64"
change mp2_cpu/dram/pdram/vhdl_memory/mem(20) X"FF"
change mp2_cpu/dram/pdram/vhdl_memory/mem(21) X"0F"
change mp2_cpu/dram/pdram/vhdl_memory/mem(22) X"20"
change mp2_cpu/dram/pdram/vhdl_memory/mem(23) X"00"
change mp2_cpu/dram/pdram/vhdl_memory/mem(24) X"A0"
change mp2_cpu/dram/pdram/vhdl_memory/mem(25) X"00"
change mp2_cpu/dram/pdram/vhdl_memory/mem(26) X"20"
...
change mp2_cpu/dram/pdram/vhdl_memory/mem(160) X"22"
change mp2_cpu/dram/pdram/vhdl_memory/mem(161) X"22"
...
change mp2_cpu/dram/pdram/vhdl_memory/mem(172) X"00"
...
change mp2_cpu/dram/pdram/vhdl_memory/mem(288) X"33"
change mp2_cpu/dram/pdram/vhdl_memory/mem(289) X"33"
change mp2_cpu/dram/pdram/vhdl_memory/mem(290) X"00"
...
run 5
echo "Done loading ../testcode/mp22-cp2.asm program code."
