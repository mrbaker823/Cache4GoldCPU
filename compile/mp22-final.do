echo "--- Executing initialization force file for ../testcode/mp22-final.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp22-final.asm program code."
run 5
...
run 5
echo "Done loading ../testcode/mp22-final.asm program code."
