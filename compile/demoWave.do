...
add wave -noupdate /mp3_cpu/PipeMem/L2_Cache/hit
add wave -noupdate -radix decimal /mp3_cpu/PipeMem/miCache/IMissCount
add wave -noupdate -radix decimal /mp3_cpu/PipeMem/mdCache/DMissCount
add wave -noupdate -radix decimal /mp3_cpu/PipeMem/L2_Cache/L2MissCount
add wave -noupdate -radix decimal /mp3_cpu/aPipelineDP/BRMissCount1
add wave -noupdate -radix decimal /mp3_cpu/aPipelineDP/BubbleCount
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {3996128 ns} 0} {{Cursor 2} {3104 ns} 0}
...
update
WaveRestoreZoom {3994439 ns} {4000303 ns}
