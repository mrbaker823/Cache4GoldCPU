echo "--- Executing initialization force file for ../testcode/multFact.asm ---"

echo "Resetting processor for 5 ns."
force /reset_l 0 @0
force /reset_l 1 @5

echo "Done initializing processor, loading ../testcode/multFact.asm program code."
run 5
...
change mp3_cpu/PipeMem/DRAM_MP3/vhdl_memory/mem(22) X"30"
change mp3_cpu/PipeMem/DRAM_MP3/vhdl_memory/mem(23) X"80"
...
change mp3_cpu/PipeMem/DRAM_MP3/vhdl_memory/mem(54) X"F7"
change mp3_cpu/PipeMem/DRAM_MP3/vhdl_memory/mem(55) X"8F"
change mp3_cpu/PipeMem/DRAM_MP3/vhdl_memory/mem(56) X"2E"
change mp3_cpu/PipeMem/DRAM_MP3/vhdl_memory/mem(57) X"82"
change mp3_cpu/PipeMem/DRAM_MP3/vhdl_memory/mem(58) X"FF"
change mp3_cpu/PipeMem/DRAM_MP3/vhdl_memory/mem(59) X"0F"
...
run 5
echo "Done loading ../testcode/multFact.asm program code."
